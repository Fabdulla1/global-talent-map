...
def generate_program_data():
    ...
    default_programs = {
        ...
        "Germany": ["STAR", "NATIONS", "EXCL", "BIG"],
        "France": ["NATIONS"],
        "India": ["BIG", "STAR"],
        "China": ["BIG"],
        "Japan": ["STAR", "NATIONS"],
        "Australia": ["STAR", "NATIONS", "BIG"],
        "Nigeria": ["STAR", "NATIONS", "EXCL"],
        "South Africa": ["STAR", "NATIONS", "BIG"],
        "Kenya": ["STAR", "EXCL"],
        "Italy": ["EXCL"],
        "Russia": ["NATIONS", "EXCL"],
        "Mexico": ["NATIONS"],
        ...
        "Egypt": ["STAR", "EXCL"],
        "Kazakhstan": ["NATIONS"],
        "Philippines": ["STAR", "NATIONS"],
        "Georgia": ["STAR", "NATIONS"],
        "Bhutan": ["STAR", "EXCL"],
        "Rwanda": ["STAR", "NATIONS", "EXCL"],
        "Albania": ["STAR"],
        "Algeria": ["STAR", "EXCL"],
        "Bangladesh": ["STAR"],
        "Bolivia": ["STAR"],
        "Botswana": ["STAR", "NATIONS"],
        "Cameroon": ["STAR"],
        "Chile": ["NATIONS"],
        "Cuba": ["STAR"],
        "Czech Republic": ["STAR"],
        ...
        "Ethiopia": ["STAR", "NATIONS"],
        "Guatemala": ["STAR", "EXCL"],
        "Ivory Coast": ["STAR"],
        "Jordan": ["STAR", "NATIONS"],
        "Kyrgyzstan": ["STAR", "NATIONS"],
        "Latvia": ["STAR"],
        "Lesotho": ["STAR"],
        "Lithuania": ["STAR", "NATIONS"],
        "Malaysia": ["STAR", "NATIONS"],
        "Mauritania": ["STAR", "NATIONS", "EXCL"],
        "Montenegro": ["STAR"],
        "Morocco": ["STAR", "NATIONS", "EXCL"],
        "Namibia": ["NATIONS"],
        "Nepal": ["STAR"],
        "Nicaragua": ["STAR", "EXCL"],
        "Pakistan": ["STAR", "NATIONS"],
        "Palestine": ["STAR"]
    }
